...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'blogger', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_886ef1b7b8335709a18d096fc4861ab7a3d571a7b8833bb7bfe0800030efa7a4');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('oloa.cedric.bts');
        $a->setPassword('zo64wb24');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ec8a72a2b4a314f19f3a92ba5418d92927d8722e');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('573a09fb772963.10876861')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'oloa.cedric.bts',
            'mailer_password' => 'zo64wb24',
            'secret' => 'ec8a72a2b4a314f19f3a92ba5418d92927d8722e',
            'locale' => 'en',
            ...
            'kernel.secret' => 'ec8a72a2b4a314f19f3a92ba5418d92927d8722e',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'oloa.cedric.bts',
            'swiftmailer.mailer.default.transport.smtp.password' => 'zo64wb24',
